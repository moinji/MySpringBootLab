...
public class BookController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<BookDTO.Response> patchBook(@PathVariable Long id, @RequestBody BookPatchDTO request) {
        BookDTO.Response updatedBook = bookService.patchBook(id, request);
        return ResponseEntity.ok(updatedBook);
    }
    
    @PatchMapping("/{id}/detail")
    public ResponseEntity<BookDTO.Response> patchBookDetail(@PathVariable Long id, @RequestBody BookDetailPatchDTO request) {
